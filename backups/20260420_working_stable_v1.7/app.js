...
const ui = {
    ...
    bandInput: document.getElementById('band-paste-input'),
    btnFetchBand: document.getElementById('btn-fetch-band'),
    btnProcessPaste: document.getElementById('btn-process-paste'),
...
async function init() {
    ...
    if (ui.memberSelect) {
        ui.memberSelect.innerHTML = MASTER_DATA.map(m => 
...
function bindEvents() {
    ...
    // Action Buttons
    ui.btnFetchBand.addEventListener('click', handleAutoFetch);
    ui.btnProcessPaste.addEventListener('click', handleManualPaste);
...
async function runAIAnalysis() {
    ...
    showModal('범용 엔진으로 배차 분석 중...', true);
